...
class ProyectsControllerTest < ActionController::TestCase
  ...
  test "should create proyect" do
    assert_difference('Proyect.count') do
      post :create, proyect: { description: @proyect.description, name: @proyect.name, user_id: @proyect.user_id }
    end
  ...
  test "should update proyect" do
    patch :update, id: @proyect, proyect: { description: @proyect.description, name: @proyect.name, user_id: @proyect.user_id }
    assert_redirected_to proyect_path(assigns(:proyect))
  end
